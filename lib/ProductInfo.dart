                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        placesWidget("farmer1", "KANYE FARM"),
                        SizedBox(
                          height: 20,
                        ),
                        Row(
    ...
    return Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              image:
                  DecorationImage(image: AssetImage("assets/imgs/$img.jpg"))),
        ),
        SizedBox(
          width: 20,
        ),
